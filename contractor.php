...
if(isset($_POST['submit']))
{
    ...
    $select="SELECT * from contractor WHERE cusername='$cusername' ";
	...
	if(mysqli_num_rows($result)> 0 )
	{
		...
		$cpass=md5($cpassword);		
		  $sql="INSERT INTO contractor(bcid,cname, caddress, cphonenumber,  cdob, cgender, ccity,cusertype,cusername, cpassword,status) VALUES ('$bid','$cname','$caddress','$cphonenumber','$cdob','$cgender','$ccity','contractor', '$cusername','$cpass','approved')";
...
function Validstr1() 
      {
        ...
        else
        {
          ...
          document.getElementById('cname').style.color = "green";
          //return true;
        }
      }
      function Validphone() 
      {
        var val = document.getElementById('cphonenumber').value;
        if (!val.match(/^[6789][0-9]{9}$/) && val!="")
       {
         document.getElementById('msg2').innerHTML="Only Numbers are allowed and must contain 10 number";
         document.getElementById('cphonenumber').value = val;
         document.getElementById('cphonenumber').style.color = "red";
          return false;
        }
        else
        {
         document.getElementById('msg2').innerHTML="";
         document.getElementById('cphonenumber').style.color = "green";
          //   return true;
        }
      }
      function Validateusername()
      {
        var email=document.getElementById('cusername').value;  
        var mailformat = /^\w+([\.-]?\w+)@\w+([\.-]?\w+)(\.\w{2,3})+$/;
        if(email.length<3||email.length>40 && email!="")
        {
         document.getElementById('email2').innerHTML="Invalid Email";
         document.getElementById('cusername').value = email;
         document.getElementById('cusername').style.color = "red";
         return false;
        }
        ...
        else
        {
         ...
         document.getElementById('cusername').style.color = "green";
          // return true;
        }
      }
      //username                                       
                          ...
                          <div class="row">
												<div class="col-md-12">
													<div class="form-group d-flex align-items-center">
											  			...
											  			<input type="text" class="form-control" placeholder="Username" id="cusername" name="cusername" onkeyup="return Validateusername()">
